...
<div class="container mt-4">
    <form action='index.php' method="POST">
        <div class="row">
            <div class="col-md-3 mb-2">
                <button type="submit" name="nueva-lista-repartos" class="btn btn-info"><i class="bi bi-plus me-1"></i>Nueva Lista de Reparto</button>
            </div>
            <div class="col-md-4">
    ...
    <table class="table mt-2">
                ...
                <th scope="col" class="text-end">
                    <form action="index.php" method="POST" id="acciones-lr">
                        <div class="btn-group" role="group">
                            ...
                            <button type="submit" name="pet-nuevo-reparto" class="btn btn-info me-2 btn-sm"><i class="bi bi-plus me-1"></i>Nuevo</button>
                            <button class="btn btn-success me-2 btn-sm ordenar"><i class="bi bi-sort-down me-1"></i>ordenar</button>
                            <button type="submit" name="borra-lista-reparto" class="btn btn-danger btn-sm" onclick="return confirm('¿Borrar Lista?')"><i class="bi bi-trash me-1"></i>Borrar</button>
                        </div>
                    </form>
                </th>
            </tr>
        ...
        <td scope="row" class="text-end">
            <form action="{{ $_SERVER['PHP_SELF'] }}" method="POST" id="acciones-lr">
                <div class="btn-group" role="group">
                    <input type="hidden" name="lista-reparto-id" value="{{ $listaReparto->getId() }}">
                    ...
                    <button type="submit" name="borra-reparto" class="btn btn-danger btn-sm" onclick="return confirm('¿Borrar reparto?')"><i class="bi bi-trash me-1"></i>Borrar</a></button>
